    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_code', models.CharField(default=forum.models.get_verification_code, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            bases=(forum.models.ForumObject, models.Model),
        ),
        migrations.CreateModel(
            name='Member',
            fields=[
        ...
        migrations.AddField(
            model_name='fic',
            name='authors',
            field=models.ManyToManyField(to='forum.Member'),
        ...
        migrations.AddField(
            model_name='user',
            name='member',
            field=models.ForeignKey(blank=True, to='forum.Member', null=True, on_delete=models.SET_NULL),
            preserve_default=True,
        ),
    ]
