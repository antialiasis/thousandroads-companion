...
MAX_FIC_NOMINATIONS = int(os.environ.get('MAX_FIX_NOMINATIONS', 5))
...
SEREBII_USER_ID = os.environ.get('REQUESTNG_USER_ID', '')
SEREBII_USER_PWHASH = os.environ.get('REQUESTING_USER_PWHASH', '')
